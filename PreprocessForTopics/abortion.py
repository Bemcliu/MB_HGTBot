...
class Abortion(Dataset):
    ...
    def train_val_test_mask(self):
        ...
        train_idx = range(9254)
        val_idx = range(9254, 9254 + 2643)
        test_idx = range(9254 + 2643, 9254 + 2643 + 1325)
...
if __name__ == '__main__':
    # twibot20 = Abortion()
    # twibot20.tweets_preprocess()
    # path = './tweets.npy'
    # data = np.load(path, allow_pickle=True)
    # print(data)

    # twibot20 = Twibot20()
    # twibot20.tweets_embedding()
    # path = './tweets_tensor.pt'
    # data = torch.load(path,weights_only=True)
    # print(data)

    # twibot_20 = Twibot20()
    # twibot_20.num_prop_preprocess()
    # path = './num_properties_tensor.pt'
    # data =torch.load(path, weights_only=True)
    # print(data)

    # twibot_20 = Twibot20()
    # com_prop = twibot_20.comments_prop_preprocess()
    # path = './com_properties_tensor.pt'
    # com_prop = torch.load(path, weights_only=True)
    # print(com_prop)

    # twibot_20 = Twibot20()
    # # print(1111)
    # # com_prop = twibot_20.Build_Graph()
    # path = './edge_index.pt'
    # edge = torch.load(path, weights_only=True)
    # print(edge)
    # exit()
    data = Abortion()
    data.dataloader()